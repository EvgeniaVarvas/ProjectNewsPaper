...
from .views import NewsList, ArticleList, PostDetail, PostCreate, PostSearch, PostUpdate, PostDelete
...
urlpatterns = [
    ...
    path('common_list/search/', PostSearch.as_view(), name='post_search'),
